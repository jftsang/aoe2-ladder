...
<tr><td class="formcell">Date (yyyy-mm-dd)</td> <td class="formcell"> <input type="text" name="date" value="<?=$date?>"/></td></tr>
  ...
  <tr><td class="formcell">CAPTCHA: What is the M in JMFT?</td> <td class="formcell"><input type="text" name="captcha"/><td class="formcell"/></tr>
  <tr><td class="formcell"></td><td class="formcell"> <input type="submit"/> </td></tr>
</table>
</form>
